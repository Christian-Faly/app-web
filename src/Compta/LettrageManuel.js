...
import ObtenirTable from '../ObtenirTable';
...
const LettrageManuel = ({gogo})=>{
    ...
    const Close=(e)=>{
        ...
        if (document.getElementById(id_etat).textContent === 'balance-auxiliaire'){
            ...
            console.log(json_select, document.getElementById('exercice-en-cours').textContent)
